    ...
    return (
        <div className="w-4/5">
            ...
            <p className="text-2xl mb-5">
                ...
                BTVI 🏫 . As a Software Engineer, I have fallen in love with web
            ...
            <div>
                ...
                <ul>
                    ...
                    <li className="text-2xl mb-5">
                        ...
                        advocate for environmental health. An additional passion
                        of mine lies in applying technology to marine science to
                        save the ocean.
                    </li>
                </ul>
            </div>
